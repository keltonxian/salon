			...
			if(import)
			{
				...
				try{
                    ...
                    if(webRequest != null)
					{
						...
						{
							EditorUtility.DisplayDialog("Error", "Can't download spreadsheet from URL: "+ webRequest.error, "OK");
							import = false;
						}
						//else if(www.isDone)
						else if(webRequest.isDone)
						{
							...
							try{
                                ...
                                //www = null;
                                List<string> rows = GetCVSLines(webRequest.downloadHandler.text);
                                webRequest = null;
					...
					if( tableIndex < settings.TableCount )
					{
			            ...
			            if (!url.Contains(".google.com"))
			            {
                            ...
                            webRequest = UnityWebRequest.Get(table.Url);
                        }
